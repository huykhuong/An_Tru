...
const FullMenuBanner = () => {
  ...
  return (
    <section className="mt-20 mb-10 max-w-[80%] lg:max-w-[70%] xl:max-w-[60%] mx-auto lg:flex lg:flex-row-reverse justify-center items-center">
      {/* Background Image */}
      ...
      {/*Contents */}
      <div className="flex flex-col justify-evenly items-start mt-20 lg:mt-0 lg:mr-20">
        ...
        >
          ...
          <div className="h-[1px] w-[40px] bg-[#001D38]"></div>
